...
export function SectionLabel({ label }: { label: string }) {
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '3rem' }} className="section-label">
  ...
  return (
    <>
      <section id="about" style={{ padding: '6rem 2rem', maxWidth: '1100px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: experience.length > 0 ? '1fr 1fr' : '1fr', gap: '3rem' }} className="about-grid">
          {/* Bio */}
          <div>
